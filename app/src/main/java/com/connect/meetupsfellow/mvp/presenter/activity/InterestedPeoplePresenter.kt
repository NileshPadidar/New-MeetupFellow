...
import com.connect.meetupsfellow.mvp.model.activity.InterestedPeopleModel
...
class InterestedPeoplePresenter(internal var mView: InterestedPeopleConnector.RequiredViewOps) :
    InterestedPeopleConnector.PresenterOps,
    InterestedPeopleConnector.RequiredPresenterOps {
    ...
    internal var mModel: InterestedPeopleConnector.ModelOps = InterestedPeopleModel(this)

    init {
        ArchitectureApp.component!!.inject(this@InterestedPeoplePresenter)
    }

    private lateinit var eventId: String

    override fun addEventIdObject(eventId: String) {
    ...
    override fun callRetrofit(type: ConstantsApi) {
        ...
        when (Connected.isConnected()) {
            false -> {
              //  returnMessage(ArchitectureApp.instance!!.getString(R.string.internet_not_connected))
                Log.e("InterestedPeoplePr","internet_not_connected")
                return
            }
        ...
        when (type) {
            ConstantsApi.INTERESTED_PEOPLE -> callForInterestedPeople(type)
//            ConstantsApi.FETCH_NEARBY -> callForNearBy(type)
    ...
    private fun callForInterestedPeople(type: ConstantsApi) {
        try {
            val people =
                apiConnect.api.interestedPeople(
                    eventId,
