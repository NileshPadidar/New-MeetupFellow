...
public class WelcomeActivityNew extends CustomAppActivityCompatViewImpl {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSharedPreferences("isFirstTime", 0).getBoolean("isFirstTime", false)){
            launchHomeScreen();
            finish();
        }
    ...
    private void launchHomeScreen() {
        ...
        getSharedPreferences("isFirstTime", 0).edit().putBoolean("isFirstTime", true).apply();
