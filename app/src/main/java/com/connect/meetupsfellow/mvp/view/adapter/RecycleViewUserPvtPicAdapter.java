...
public class RecycleViewUserPvtPicAdapter extends RecyclerView.Adapter<RecycleViewUserPvtPicAdapter.MyViewHolder>{
    ...
    public RecycleViewUserPvtPicAdapter(Context context, ArrayList<RecycleModel> userPics) {
    ...
    @NonNull
    @Override
    public RecycleViewUserPvtPicAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Inflate the layout (Giving look)
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.user_prics_rv, parent, false);
        return new RecycleViewUserPvtPicAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleViewUserPvtPicAdapter.MyViewHolder holder, int position) {
