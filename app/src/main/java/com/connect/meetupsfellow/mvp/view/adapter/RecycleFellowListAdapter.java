...
import com.connect.meetupsfellow.mvp.view.activities.AddNewGroupMembersActivity;
...
public class RecycleFellowListAdapter extends RecyclerView.Adapter<RecycleFellowListAdapter.MyViewHolder> implements Filterable {
    ...
    public RecycleFellowListAdapter(Context context, ArrayList<RecycleModel> users) {
    ...
    @NonNull
    @Override
    public RecycleFellowListAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //Inflate the layout (Giving look)
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.item_user_chat_list, parent, false);
        return new RecycleFellowListAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull RecycleFellowListAdapter.MyViewHolder holder, int position) {
            ...
            public void onClick(View v) {
                ...
                if (isChecked) {
                    ...
                    if (users.get(pos).getUserId() != null) {
                        ...
                        ((AddNewGroupMembersActivity) context).addOrRemoveFellowsToGroup(users.get(pos).getUserId(), users.get(pos).getUserName());
                    }
                } else {
