...
import com.connect.meetupsfellow.mvp.view.fragment.FollowingFragment
import com.connect.meetupsfellow.retrofit.response.MyFollowFollowingListRes

class MyFollowingAdapter() :  RecyclerView.Adapter<MyFollowingAdapter.ConnectRequestViewHolder>() {

    private val connectArray = ArrayList<MyFollowFollowingListRes>()
    private lateinit var context: Context
    private lateinit var myFragment: FollowingFragment

    internal fun add(
        context: Context,
        fragment : FollowingFragment,
        users: ArrayList<MyFollowFollowingListRes>
    ) {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): MyFollowingAdapter.ConnectRequestViewHolder {
    ...
    inner class ConnectRequestViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(connectItem: MyFollowFollowingListRes, position: Int) {
            ...
            btn_cancel_request.text = "Unfollow"
            ...
            btn_cancel_request.setOnClickListener(){
                myFragment.unFollowUser(connectItem.userId!!)
            }
