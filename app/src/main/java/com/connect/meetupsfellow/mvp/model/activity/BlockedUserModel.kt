...
class BlockedUserModel(internal var mPresenter: BlockedUsersConnector.RequiredPresenterOps) :
    BlockedUsersConnector.ModelOps {
    ...
    init {
        ArchitectureApp.component!!.inject(this@BlockedUserModel)
    }
