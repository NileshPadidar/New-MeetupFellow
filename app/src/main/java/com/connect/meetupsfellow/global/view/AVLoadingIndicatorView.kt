...
import com.connect.meetupsfellow.global.view.indicators.BallPulseIndicator
import com.connect.meetupsfellow.log.LogManager


@Suppress("UNUSED_VALUE", "NAME_SHADOWING", "USELESS_IS_CHECK", "unused")
class AVLoadingIndicatorView : View {
    ...
    //need to set indicator color again if you didn't specified when you add the indicator .
    ...
    private fun init(context: Context, attrs: AttributeSet?, defStyleAttr: Int, defStyleRes: Int) {
        ...
        mIndicatorColor = a.getColor(R.styleable.AVLoadingIndicatorView_indicatorColor, ContextCompat.getColor(
            ArchitectureApp.instance!!, R.color.colorLoading))
    ...
    private fun setIndicator(indicatorName: String?) {
        ...
        try {
            ...
            LogManager.logger.e(TAG, "Didn't find your class , check the name again !")
    ...
    override fun verifyDrawable(who: Drawable): Boolean =
            who === indicator || super.verifyDrawable(who)
